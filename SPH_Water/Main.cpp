...
// (i.e. life < 0);
//I vårat fall borde vi kunna skippa detta och bara räkna uppåt (partiklar ska ju ändå inte försvinna!!!!!!!!!!
...
int main(void)
{
	...
	// Create and compile our GLSL program from the shaders (now Ingmar version)
